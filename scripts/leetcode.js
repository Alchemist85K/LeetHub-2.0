...
const isLeetCodeV2 = () => {
  ...
  const bodyContainsChakraUILight = !!document.querySelector('body.chakra-ui-light');
  const bodyContainsChakraUIDark = !!document.querySelector('body.chakra-ui-dark');
  return rootElementNextApp || bodyContainsChakraUIDark || bodyContainsChakraUILight;
};
